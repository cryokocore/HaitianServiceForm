...
doc.addFont("Emirates-Bold.ttf", "Emirates", "bold");
    ...
    // const pageHeight = doc.internal.pageSize.height; // Get page height
    const footerY = pageHeight - 23; // Adjust footer position from bottom
    const centerX = doc.internal.pageSize.width / 2; // Get center alignment
    const leftAlignX = 40; // Adjust for left-side text
    const rightAlignX = doc.internal.pageSize.width - 80; // Adjust for right-side text
    doc.setTextColor("#0C3C74");
    ...
    doc.setFont("Emirates", "bold");
    doc.setFontSize(13);
    doc.text("Haitian Middle East FZE", centerX, footerY, { align: "center" });

    // **Second Row: "Sharjah - U.A.E" (left) and "+971 65 622 238" (right)**
    doc.setFontSize(9);
    doc.text("PO BOX: 49648", leftAlignX + 65, footerY + 5, {
      align: "center",
    });
    // doc.text("Phase 1, Hamriya Free Zone Sharjah, UAE", rightAlignX-3, footerY + 6, { align: "center" });
    doc.setFontSize(9);

    doc.text(
      "Phase 1, Hamriya Free Zone Sharjah, UAE",
      leftAlignX + 38,
      footerY + 10
    );
    ...
    // **Third Row: "Email" (left) and "Web" (right)**
    doc.text("Email: ask@haitianme.com", leftAlignX + 28, footerY + 15);
    doc.text("Web: www.haitianme.com", rightAlignX + 12, footerY + 15, {
      align: "right",
    });
